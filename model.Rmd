...
## Existing Data Plot & Performance

```{r}
sp_data_train$median_td_score_fitted <- gwrG_td$SDF$pred

colors <- c("white", "darkred")
spplot(sp_data_train, "median_td_score_fitted", col.regions = colorRampPalette(colors)(60),
       cuts = 30, main = "Fitted Median Temporal Discounting Score")

sp_data_train$median_ag_score_fitted <- gwrG_ag$SDF$pred

colors <- c("white", "darkblue")
spplot(sp_data_train, "median_ag_score_fitted", col.regions = colorRampPalette(colors)(60), 
       cuts = 30, main = "Fitted Median Agency Score")

sp_data_train$median_los_score_fitted <- gwrG_los$SDF$pred

colors <- c("white", "darkgreen")
spplot(sp_data_train, "median_los_score_fitted", col.regions = colorRampPalette(colors)(60),
       cuts = 30, main = "Fitted Median Loss Aversion Score")
```
